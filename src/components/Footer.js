...
const Footer = () => {
  return (
    <div className="flex w-full h-fit flex-col gap-6 items-center justify-center py-14 px-10 overflow-hidden relative">
      <h1 className="text-grayWhite text-2xl w-52 text-center font-rocaone">
      ...
      <button className="bg-buttonBg p-2.5 w-full text-white font-proxima rounded-[4px] font-[700]">
        Apply Now
      </button>
      <div className="flex gap-[17.35px] mt-1">
